...
int main()
{
    ...
    int id[SIZE] = {139, 152, 170, 193, 230, 251, 273, 294, 362, 385, 435, 481};

    string name[SIZE] = {"Sydney Thompson", "Michael Anthony", "Courtney Zito", 
...
"Carloine Hagan", "Matthew Messer", "Brittany Jolly", "Josh Sinclare", "Erick Garant"};
    ...
    string email[SIZE] = {"st139@txstate.edu", "ma152@txstate.edu", "cz170@txstate.edu", "am193@txstate.edu", "nm230@txstate.edu", "mb251@txstate.edu", "br273@txstate.edu", "ch294@txstate.edu", "mm362@txstate.edu", "bj385@txstate.edu", "js435@txstate.edu", "eg481@txstate.edu"};
